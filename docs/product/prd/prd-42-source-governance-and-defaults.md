...
- `src/lib/observability/runtime-source-resolution.ts` builds a safe runtime source-resolution snapshot with governed source IDs only.
...
- Repo evidence used:
  ...
  - `src/lib/observability/runtime-source-resolution.ts`
