...
| --- | --- | --- | --- | --- | --- |
| PRD-44 | `/Users/bm/Documents/daily-intelligence-aggregator-auth-forms` | `feature/prd-44-auth-entry-forms` | `origin/feature/prd-44-auth-entry-forms` | `1d40359` | Canonical prepared for merge sequencing; draft PR #79 open with CI and preview smoke passing; human OAuth/session validation pending |
...
- PRD-44 has been processed first on the canonical owner branch. The branch now includes `docs/engineering/change-records/prd-44-auth-entry-forms-governance-coverage.md`, contains `origin/main` at merge-base `c124f56`, passes `scripts/release-governance-gate.py` locally for the PRD-44 diff, has green GitHub checks and Vercel preview smoke validation for `/login` and `/signup`, and has draft PR #79 open at `https://github.com/brandonma25/daily-intelligence-aggregator/pull/79` for remaining human OAuth/session validation before merge.
